...
def attack(char_name: str, char_class: str) -> str:
    """Провекра класса, урон основной и случайный урон от класса."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс противнику урон, равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} неудачная атака')


def defence(char_name: str, char_class: str) -> str:
    """Провекра класса, блок = основной + случайный блок от класса."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} неудачная блокировка')


def special(char_name: str, char_class: str) -> str:
    """Провекра класса, параметров от специальнго умения."""
    if char_class == 'warrior':
